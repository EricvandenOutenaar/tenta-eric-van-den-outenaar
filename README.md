...
I have created a 'demo' Travel Blog for this assignment (actual places I have been). I haven't created real content though (only article headlines/fotos). In the following document you will first find some installing instructions. After that you can read my conclusions concerning the different technologies that we discussed in our course for making dynamic websites. That part will be in Swedish.
